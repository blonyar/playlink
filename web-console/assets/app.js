...
const elements = {
  ...
  roomsRefreshButton: document.querySelector('#rooms-refresh-button'), roomsBody: document.querySelector('#rooms-body'), roomSearch: document.querySelector('#room-search'), roomFilter: document.querySelector('#room-filter'), openCreateRoomButton: document.querySelector('#open-create-room-button'), createRoomDialog: document.querySelector('#create-room-dialog'), closeCreateRoomButton: document.querySelector('#close-create-room-button'),
...
function renderRooms() {
  ...
  elements.roomsBody.replaceChildren(...visibleRooms.map((room) => {
    ...
    button.disabled = isCurrent || isFull || !socket || socket.readyState !== WebSocket.OPEN;
