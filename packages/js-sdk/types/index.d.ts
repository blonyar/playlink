// @playlink/client — TypeScript Definitions
//
// Mirrors the v1.x public surface. Internal helpers (utils.js) are
// not exported from `src/index.js` and are therefore not declared
// here.
...
export const DEFAULT_HTTP_URL: string;
